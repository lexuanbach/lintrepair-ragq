...
echo "[1/5] aggregate the 18-model cross-model table ...";      python3 experiments/aggregate_models.py        >/dev/null
echo "[2/5] revision analyses (stratified/family/capability) ..."; python3 experiments/run_revision_analyses.py >/dev/null
echo "[3/5] interaction regression + loss/detector-audit ...";  python3 experiments/run_revision_interaction.py >/dev/null
